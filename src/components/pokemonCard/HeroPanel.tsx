    ...
    >
      <div className={classes.pokeHeroImageWrap}>
        ...
        {shinyFxMode ? (
          <>
            <span
              className={`${classes.pokeShinyTwinkle} ${shinyFxMode === 'on' ? classes.pokeShinyTwinkleOn : classes.pokeShinyTwinkleOff} ${classes.pokeShinyTwinkleA}`}
              aria-hidden="true"
            >
              ✦
            </span>
            <span
              className={`${classes.pokeShinyTwinkle} ${shinyFxMode === 'on' ? classes.pokeShinyTwinkleOn : classes.pokeShinyTwinkleOff} ${classes.pokeShinyTwinkleB}`}
              aria-hidden="true"
            >
              ✧
            </span>
            <span
              className={`${classes.pokeShinyTwinkle} ${shinyFxMode === 'on' ? classes.pokeShinyTwinkleOn : classes.pokeShinyTwinkleOff} ${classes.pokeShinyTwinkleC}`}
              aria-hidden="true"
            >
              ✦
            </span>
            <span
              className={`${classes.pokeShinyTwinkle} ${shinyFxMode === 'on' ? classes.pokeShinyTwinkleOn : classes.pokeShinyTwinkleOff} ${classes.pokeShinyTwinkleD}`}
              aria-hidden="true"
            >
              ✧
            </span>
